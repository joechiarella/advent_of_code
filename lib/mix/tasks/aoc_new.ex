defmodule Mix.Tasks.AocNew do
  ...
  def run([day]) do
    ...
    render_template("lib/mix/tasks/new_day_template.eex", "lib/aoc2025_#{day}.ex", data)

    render_template(
      "lib/mix/tasks/new_day_test_template.eex",
      "test/aoc2025_#{day}_test.exs",
      data
    )

    write_file("test/data/2025_#{day}_input.txt", "")
